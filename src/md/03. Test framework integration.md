...
|rp.keystore.resource=your_keystore.jks|Put your JKS file into resources and specify path to it | |
|rp.keystore.password=keystore_pass |Access password for JKS (certificate storage) package, mentioned above | |
