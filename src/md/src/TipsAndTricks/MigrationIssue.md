...
1. At first, you need to check the logs of migration, it can be helpful, if yes, make some actions based on logs, if not then move next.
...
1. Check the logs, in case we've found nothing, move next.
