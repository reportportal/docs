...
-   **Number** - At least 1 symbols are required for this search. 
...
-   **Analysed by RP (AA)** - there are two position: With AA mark, Without AA mark.

-   **Ignored in AA** -  there are two position: With Ignore mark, Without Ignore mark.

-   **Issue in BTS** - there are two position: Linked bug, No linked bug.
