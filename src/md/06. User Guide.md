...
- Launch inactivity timeout - this parameter specifies the scheduled time
    for a job to interrupt inactive launches. There are 6 options: 1 hour, 3
...
8. Enter your email into "From" field. This email will be used as notification sender.
...
7. Click "Add" button. New dashboard will be created.
...
Report Portal allows to see shared by other project member dashboards by direct link.

[ ![Image](Images/pic_256.jpg) ](Images/pic_256.jpg)

### Edit own dashboard

To edit a dashboard, navigate to the "Dashboards" page and click "Edit" button in the top right corner of the page.
...
4. Widget Wizard will be opened. All wizard tabs are marked as "Undone". Fill in all tabs to add a new widget.
...
- Actions for Widget - actions, that will be presented. The following actions are available: Update project settings, Update Defect Types, Delete launch, Start launch, Finish launch, Share widget, dashboard, Unshare widget, dashboard, Post issue to BTS, Add, register user, Update BTS. By default all actions are checked.
...
To configure the widget, click "Add Widget" button on the dashboard header and select template 

You can specify "Items count" - number of launches, that will be shown on the widget (not more than 150 launches).
...
- Found in - links to the log levels of all the items, to which the bug was posted/added.
