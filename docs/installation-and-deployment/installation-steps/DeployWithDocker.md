...
[See advanced deployment recommendations](../HardwareRequirements.mdx).
:::
...
* **Backups**: Schedule periodic backups of the PostgreSQL database and Storage. [How to backup ReportPortal guide](../../administration-and-maintenance/BackupRestoreGuide.md)
