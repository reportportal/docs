...
<MediaViewer src={require('./img/glossary/Glossary1.png')} alt="Documentation about Agents on GitHub" />
...
<MediaViewer src={require('./img/glossary/Glossary2.png')} alt="Documentation about Clients on GitHub" />
...
<MediaViewer src={require('./img/glossary/Glossary3.png')} alt="How OkHttp3 logger works" />
...
<MediaViewer src={require('./img/glossary/Glossary4.png')} alt="Quality Gates plugin in our test reporting tool" />
...
<MediaViewer src={require('./img/glossary/Glossary5.png')} alt="Example of Launches in our test automation results dashboard" />
...
<MediaViewer src={require('./img/glossary/Glossary6.png')} alt="Example of Suites in our real time dashboard open source" />
...
<MediaViewer src={require('./img/glossary/Glossary7.png')} alt="Example of Steps in our test automation dashboard" />
...
<MediaViewer src={require('./img/glossary/Glossary10.png')} alt="Example of Nested step in our centralized test automation tool" />
...
<MediaViewer src={require('./img/glossary/Glossary8.png')} alt="Example of Logs in our continuous testing platform" />
...
<MediaViewer src={require('./img/glossary/Glossary9.png')} alt="Test Case ID scheme on ReportPortal" />
