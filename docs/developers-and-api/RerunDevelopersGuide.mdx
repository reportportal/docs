---
sidebar_label: Rerun developers guide
...
To start launch rerun you should call [default start launch endpoint](./ReportingDevelopersGuide.md#start-launch) adding `"rerun"=true` parameter in the request body.
...
To start launch rerun you should call [default start launch endpoint](./ReportingDevelopersGuide.md#start-launch) adding `"rerun"=true` and `"rerunOf"=launch_uuid` parameters in the request body. Where `launch_uuid` is UUID of launch that have to be reruned.
