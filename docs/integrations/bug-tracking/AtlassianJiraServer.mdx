...
description: Integrate Jira Server with your test automation reporting tool to track defects, sync statuses, and streamline bug reporting.
---
...
:::important
Admin can upload Jira Server plugin and create global integrations (applicable to all projects on the instance) on the Instance plugins page.<br />
...
If any project needs different Jira Server configurations, you can add a project configuration. This means that when a new global integration is added to our centralized test automation tool, it will no longer be applied to this project.
