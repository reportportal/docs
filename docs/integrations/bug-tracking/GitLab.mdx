...
description: Integrate GitLab to post issues, link defects, and sync status updates seamlessly.
---

# GitLab

To install the GitLab plugin, see [Upload plugin](../ManagePlugins.mdx#upload-plugin) section.
...
:::info
Admin, Manager, and user with edit permissions can create/edit/delete GitLab integration.<br />
...
If any project needs different GitLab BTS configurations, you can add a project configuration. This means that when a new global integration is added to our test automation results dashboard, it will no longer be applied to this project.
