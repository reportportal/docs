...
:::important
Admin can upload a plugin and create global integrations on the Instance plugins page. <br />
Manager can work only on the project level. He can re-write global configuration with project ones on Project Settings -> Integrations.
:::
