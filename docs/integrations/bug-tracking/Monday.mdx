...
:::important
Admin can upload Monday plugin and create global integrations (applicable to all projects on the instance) on the Instance plugins page.<br />
Manager and user with edit permissions can re-write global configuration with project ones on Project Settings -> Integrations.
:::
