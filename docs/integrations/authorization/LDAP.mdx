---
sidebar_label: LDAP
description: Configure LDAP integration in your test automation results dashboard with secure encryption.
---
...
LDAP plugin is available in ReportPortal on the Instance plugins.
...
If you are experiencing issues, [check the LDAP connection](../../administration-and-maintenance/issues-troubleshooting/HowToCheckLDAPConnection.md).
