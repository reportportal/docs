...
`pytest` command. Your tests should be already [integrated with a ReportPortal agent](../test-frameworks/index.mdx). You also need a working ReportPortal instance and access to your secret storage, E.G.
