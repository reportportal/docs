...
* Other: Organizations, Sauce Labs, Mobitru, Quality Gates, Test Executions
...
**Permissions:**
Only ADMIN can update the plugin.
...
**Permissions:**
Only ADMIN can enable / disable plugin.
...
**Permissions:**
Only ADMIN can uninstall the plugin.
