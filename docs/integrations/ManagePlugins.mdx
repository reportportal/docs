...
* Other: Sauce Labs, Organizations, Mobitru, Quality Gates, Test Executions
...
|E-mail | You do not need to download these plugins, there are already available on the Plugin page|
| LDAP | [premium feature](https://reportportal.io/pricing/saas/) |
| SAML | [premium feature](https://reportportal.io/pricing/saas/) |
| Organization | [premium feature](https://reportportal.io/pricing/saas/) |
| Quality Gates | [premium feature](https://reportportal.io/pricing/saas/) |
| Test Executions | [premium feature](https://reportportal.io/pricing/saas/) |
| Teams | [premium feature](https://reportportal.io/pricing/saas/) |

<MediaViewer src="https://youtu.be/57QfOZ8hGwg" alt="Upload Plugin to our open source test reporting tool" type="video" />

For a plugin uploading perform the following actions:
...
Users can configure a plugin on the instance level (global configuration), organization level and also on the project level (project configuration). The configuration is the same for both levels.
