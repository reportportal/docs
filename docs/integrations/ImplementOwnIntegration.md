...
You can find a detailed description of how report results to ReportPortal in our [developers` guide](../developers-and-api/ReportingDevelopersGuide.md).

Based on this information you can create your integration with a test framework.

Consider using our [Reporting SDKs](../test-results-reporting/ReportingSDK.md) for different programming languages.
