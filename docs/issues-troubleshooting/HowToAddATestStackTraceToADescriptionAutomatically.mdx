...
description: Automatically add test stack traces to descriptions for faster test failure analysis in ReportPortal test automation reporting tools.
---
...
<MediaViewer src={require('./img/TipAndTricksStackTrace.png')} alt="Add a description for failed tests automatically in our test report dashboard" />
