...
ReportPortal includes a [SCIM Server](../../integrations/UserProvisioning/Scim/index.md) that acts as a bridge between your identity provider and ReportPortal, streamlining the management of user accounts.
