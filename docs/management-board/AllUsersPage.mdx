...
<media-view thumbnail={require('./img/addUserFromAllUsersPage.png')} src="https://youtu.be/3DmBPpRKRwk" alt="addUserFromAllUsersPage" type="video" />
...
<media-view thumbnail={require('./img/inviteUserFromAllUsers.png')} src="https://youtu.be/MM0eNrDK5yo" alt="inviteUserFromAllUsers" type="video" />
...
<media-view thumbnail={require('./img/assignUnassignUserFromAllUsers.png')} src="https://youtu.be/DGssKgYmbds" alt="assignUnassignUserFromAllUsers" type="video" />
...
<media-view thumbnail={require('./img/editProjectRoleFromAllUsers.png')} src="https://youtu.be/Kb19uMYm0wM" alt="editProjectRoleFromAllUsers" type="video" />
...
<media-view thumbnail={require('./img/deleteUser.png')} src="https://youtu.be/8kaqZPyW5KQ" alt="deleteUser" type="video" />
...
<media-view thumbnail={require('./img/changeAccountRole.png')} src="https://youtu.be/U6xmYzDwwbI" alt="changeAccountRole" type="video" />
...
<media-view thumbnail={require('./img/changeAccountRole.png')} src="https://youtu.be/7pLNEDY7Uis" alt="changeAccountRole" type="video" />
