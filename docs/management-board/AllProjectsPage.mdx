...
<media-view thumbnail={require('./img/generalView.png')} src="https://youtu.be/ss-a39f5A9M" alt="generalView" type="video" />
...
<media-view thumbnail={require('./img/addUserFromProjectMembersPage.png')} src="https://youtu.be/nkJmxlMfR1Q" alt="addUserFromProjectMembersPage" type="video" />
...
<media-view thumbnail={require('./img/inviteUserFromMembersPageInMB.png')} src="https://youtu.be/wK0PB-iVEjk" alt="inviteUserFromMembersPageInMB" type="video" />
...
<media-view thumbnail={require('./img/deleteProject.png')} src="https://youtu.be/bipey3GxCiw" alt="deleteProject" type="video" />
