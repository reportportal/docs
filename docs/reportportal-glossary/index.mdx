...
<media-view src={require('./img/Glossary4.png')} alt="Quality Gates plugin on ReportPortal" />
...
<media-view src={require('./img/Glossary5.png')} alt="Example of Launches on ReportPortal" />
...
<media-view src={require('./img/Glossary6.png')} alt="Example of Suites on ReportPortal" />
...
<media-view src={require('./img/Glossary7.png')} alt="Example of Steps on ReportPortal" />
...
<media-view src={require('./img/Glossary3.png')} alt="Example of Nested step on ReportPortal" />
...
<media-view src={require('./img/Glossary8.png')} alt="Example of Logs on ReportPortal" />
