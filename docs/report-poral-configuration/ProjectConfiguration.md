...
For more information on this topic, please refer to [Integration with external systems](./IntegrationsViaPlugin).
...
[![Image](img/manageUsers/inviteUserFromProjectMembersPage.png)](https://youtu.be/BLI-IlTkSgI)
