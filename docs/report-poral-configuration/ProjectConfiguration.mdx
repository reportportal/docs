...
<media-view thumbnail={require('./img/managingProjects/generalConf.png')} src="https://youtu.be/GsBGyhj-V6s" alt="generalConf" type="video" />
...
<media-view thumbnail={require('./img/managingProjects/defectTypesConf.png')} src="https://youtu.be/z8iWXXk6A6Q" alt="defectTypesConf" type="video" />
...
<media-view thumbnail={require('./img/managingProjects/demoData.png')} src="https://youtu.be/YGBZfCvfdVw" alt="demoData" type="video" />
...
<media-view thumbnail={require('./img/manageUsers/inviteUserFromProjectMembersPage.png')} src="https://youtu.be/BLI-IlTkSgI" alt="inviteUserFromProjectMembersPage" type="video" />
...
<media-view thumbnail={require('./img/manageUsers/editProjectRoleFromProjectMembersPage.png')} src="https://youtu.be/aH1viL0FFlw" alt="editProjectRoleFromProjectMembersPage" type="video" />
