...
<media-view src={require('./img/widget-types/testCasesGrowthTrendChart.png')} alt="testCasesGrowthTrendChart" />
...
<media-view src={require('./img/widget-types/testCasesGrowthTrendChartTimeline.png')} alt="testCasesGrowthTrendChartTimeline" />
