...
<media-view src={require('./img/widget-types/PassingRateSummary1.png')} alt="Add Passing Rate Summary Widget" />

<media-view src={require('./img/widget-types/PassingRateSummary2.png')} alt="Passing Rate Summary Widget Configuration" />
...
<media-view src={require('./img/widget-types/PassingRateSummary3.png')} alt="Dashboard for QA automation: Passing Rate Summary Bar View" />

Pie view

<media-view src={require('./img/widget-types/PassingRateSummary4.png')} alt="Passing Rate Summary Pie view" />

As you can see, this widget was built based on the “regression” filter.

<media-view src={require('./img/widget-types/PassingRateSummary5.png')} alt="Regression filter" />
...
<media-view src={require('./img/widget-types/PassingRateSummary6.png')} alt="Percentage ratio for the specified set of launches" />
