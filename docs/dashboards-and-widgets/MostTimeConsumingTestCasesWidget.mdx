...
<media-view thumbnail={require('./img/widget-types/TheMostTimeConsumingTestCasesWidgetBar.png')} src="https://youtu.be/tYaPUW9Uwmk" alt="MostTimeConsuming" type="video" />

<media-view src={require('./img/widget-types/TheMostTimeConsumingTestCasesWidgetTable.png')} alt="MostTimeConsuming Table" />