...
<media-view src={require('./img/widget-types/ComponentHealthCheckScheme1.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme2.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme3.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme4.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme5.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme6.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme7.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme8.png')} alt="ComponentHealthCheckWidgetScheme" />

<media-view src={require('./img/widget-types/ComponentHealthCheckScheme9.png')} alt="ComponentHealthCheckWidgetScheme" />
...
<media-view src={require('./img/widget-types/ComponentHealthCheckView.png')} alt="ComponentHealthCheckView" />
