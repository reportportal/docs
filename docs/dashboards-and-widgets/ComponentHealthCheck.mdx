...
:::
<MediaViewer thumbnail={require('./img/widget-types/ComponentHealthCheckView.png')} src="https://youtu.be/T98iy0mJk0s" alt="Component Health Check Video" type="video" />
