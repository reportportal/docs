...
<media-view thumbnail={require('./img/widget-types/TheMostTimeConsumingTestCasesWidgetBar.png')} src="https://youtu.be/tYaPUW9Uwmk" alt="Most Time Consuming Test Cases Widget Video" type="video" />

<media-view src={require('./img/widget-types/TheMostTimeConsumingTestCasesWidgetTable.png')} alt="Dashboard for QA automation: Most Time Consuming Test Cases Table" />
