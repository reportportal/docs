...
description: Identify the slowest test cases with duration analysis. View top 20 time-consuming tests in table or bar format using qa dashboard tools.
---
...
<MediaViewer src="https://youtu.be/tYaPUW9Uwmk" alt="Most Time Consuming Test Cases Widget Video" type="video" />

<MediaViewer src={require('./img/widget-types/MostTimeConsumingTestCasesWidget.png')} alt="Dashboard for QA automation: Most Time Consuming Test Cases Table" />
