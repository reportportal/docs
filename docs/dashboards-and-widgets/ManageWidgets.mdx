...
description: Customize, resize, edit, and delete widgets on your dashboard. Organize layout and manage widget settings for optimal test automation reporting tools experience.
---
...
<MediaViewer src="https://youtu.be/icuOipeRtAU" alt="Customize widgets in our qa automation dashboard" type="video" />
...
<MediaViewer src="https://youtu.be/F-K0sM66lhY" alt="Edit Widget" type="video" />
...
<MediaViewer src="https://youtu.be/pACkyeSH5mc" alt="Delete Widget" type="video" />
