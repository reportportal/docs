...
<media-view thumbnail={require('./img/manage-widgets/customizeWidget.png')} src="https://youtu.be/6nPsNI2v_po" alt="customizeWidget" type="video" />
...
<media-view thumbnail={require('./img/manage-widgets/editWidget.png')} src="https://youtu.be/VlpvP7IIEoY" alt="editWidget" type="video" />
...
<media-view thumbnail={require('./img/manage-widgets/deleteWidget.png')} src="https://youtu.be/BrY6BnW7aAE" alt="deleteWidget" type="video" />
