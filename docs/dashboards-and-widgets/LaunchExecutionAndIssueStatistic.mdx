...
<media-view src={require('./img/widget-types/LaunchExecutionAndIssueStatistic.png')} alt="Data visualization in test automation: Launch Execution And Issue Statistic Widget" />
