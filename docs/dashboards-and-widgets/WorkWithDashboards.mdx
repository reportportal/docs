...
<media-view thumbnail={require('./img/dashboards/CreateDashboard.png')} src="https://youtu.be/dP_AqeWWu7w" alt="Create test execution dashboard" type="video" />
...
<media-view thumbnail={require('./img/dashboards/EditDashboard.png')} src="https://youtu.be/BuzggC_kKcs" alt="Edit dashboard" type="video" />
...
<media-view thumbnail={require('./img/dashboards/DeleteDashboard.png')} src="https://youtu.be/ICqrwD5rRLU" alt="Delete dashboard" type="video" />
