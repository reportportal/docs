...
description: Track non-passed test trends over time to identify quality issues. Monitor failed and skipped test percentages using qa dashboard tools.
---
...
<MediaViewer src={require('./img/widget-types/NonPassedTestCasesTrendChart.png')} alt="Dashboard for QA automation: Non Passed Test Cases Trend Chart Widget" />
