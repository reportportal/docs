...
<MediaViewer src={require('./img/widget-types/DifferentLaunchesComparisonChart.png')} alt="Data visualization in test automation: Different Launches Comparison Chart Widget" />
