...
<MediaViewer thumbnail={require('./img/manage-widgets/CreateWidget.png')} src="https://youtu.be/GdyAM_6Nz10" alt="Create widget for test report&analytics dashboard" type="video" />
