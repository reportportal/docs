...
description: Identify top 20 most common failure patterns across launches. Analyze recurring issues and improve test stability using qa metrics dashboard.
---
...
<MediaViewer src={require('./img/widget-types/MostPopularPatternTable1.png')} alt="Create Most Popular Pattern Table Widget" />
...
<MediaViewer src={require('./img/widget-types/MostPopularPatternTable2.png')} alt="Dashboard for QA automation: Most Popular Pattern Table Widget" />
