...
<media-view src={require('./img/widget-types/investigatedPercentageOfLaunches.png')} alt="investigatedPercentageOfLaunches" />
...
<media-view src={require('./img/widget-types/investigatedPercentageOfLaunchesTimeline.png')} alt="investigatedPercentageOfLaunchesTimeline" />
