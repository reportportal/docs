...
<media-view src={require('./img/widget-types/CumulativeCreation.png')} alt="CumulativeCreation" />
...
<media-view src={require('./img/widget-types/CumulativeScheme1.png')} alt="CumulativeScheme" />

<media-view src={require('./img/widget-types/CumulativeScheme2.png')} alt="CumulativeScheme" />

<media-view src={require('./img/widget-types/CumulativeScheme3.png')} alt="CumulativeScheme" />

<media-view src={require('./img/widget-types/CumulativeScheme4.png')} alt="CumulativeScheme" />

<media-view src={require('./img/widget-types/CumulativeScheme5.png')} alt="CumulativeScheme" />

<media-view src={require('./img/widget-types/CumulativeFirstLevelView.png')} alt="CumulativeFirstLevelView" />
