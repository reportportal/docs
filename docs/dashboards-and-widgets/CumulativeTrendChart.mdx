...
<media-view thumbnail={require('./img/widget-types/CumulativeFirstLevelView.png')} src="https://youtu.be/F51a1JpEITo" alt="Cumulative Video" type="video" />
...
<media-view src={require('./img/widget-types/CumulativeCreation.png')} alt="Cumulative Creation" />
...
<media-view src={require('./img/widget-types/CumulativeScheme1.png')} alt="All launches in ReportPortal" />

<media-view src={require('./img/widget-types/CumulativeScheme2.png')} alt="Take launches from the filter" />

<media-view src={require('./img/widget-types/CumulativeScheme3.png')} alt="Leave test cases with attributes key for 1 level" />

<media-view src={require('./img/widget-types/CumulativeScheme4.png')} alt="Group by unique attribute" />

<media-view src={require('./img/widget-types/CumulativeScheme5.png')} alt="Leave only latest launches for each group" />

<media-view src={require('./img/widget-types/CumulativeFirstLevelView.png')} alt="Dashboard to manage test results: Cumulative trend chart First Level View" />
