...
description: Identify top 50 most problematic test cases with failure statistics. Track last failure dates and enable flaky test detection using test automation metrics dashboard.
---
...
<MediaViewer src={require('./img/widget-types/MostFailedTestCases.png')} alt="Data visualization in test automation: Most Failed Test Cases Table Widget" />
