...
<media-view src={require('./img/widget-types/launchStatisticsChart1.png')} alt="launchStatisticsChart1" />
...
Area view
<media-view src={require('./img/widget-types/launchStatisticsChartArea.png')} alt="launchStatisticsChartArea" />

Bar view
<media-view src={require('./img/widget-types/launchStatisticsChartBar.png')} alt="launchStatisticsChartBar" />
...
Area view
<media-view src={require('./img/widget-types/launchStatisticsChartArea1.png')} alt="launchStatisticsChartArea1" />

Bar view
<media-view src={require('./img/widget-types/launchStatisticsChartBar1.png')} alt="launchStatisticsChartBar1" />
