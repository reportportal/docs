...
Area view
<MediaViewer src={require('./img/widget-types/LaunchStatisticsChartArea.png')} alt="Data visualization in test automation: Launch statistics chart" />

Bar view
<MediaViewer src={require('./img/widget-types/LaunchStatisticsChartBar.png')} alt="Launch Statistics Chart Launch mode Bar view" />
...
Area view
<MediaViewer src={require('./img/widget-types/LaunchStatisticsChartArea1.png')} alt="Launch Statistics Chart Timeline mode Area view" />

Bar view
<MediaViewer src={require('./img/widget-types/LaunchStatisticsChartBar1.png')} alt="Launch Statistics Chart Timeline mode Bar View" />
