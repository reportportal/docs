...
<MediaViewer src={require('./img/widget-types/ComponentHealthCheckTableBuild.png')} alt="Dashboard to manage test results: Component Health Check Table" />
...
<MediaViewer src={require('./img/widget-types/ComponentHealthCheckTableFeature.png')} alt="Component Health Check Table Key Feature" />

Widget logic is the same as for [Component health check](/dashboards-and-widgets/ComponentHealthCheck).

<MediaViewer src="https://youtu.be/uRCpA7zivZU" alt="Component Health Check Table Widget Video" type="video" />
