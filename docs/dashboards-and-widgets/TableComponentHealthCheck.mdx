...
<MediaViewer thumbnail={require('./img/widget-types/ComponentHealthCheckTableBuild.png')} src="https://youtu.be/uRCpA7zivZU" alt="Component Health Check Table Widget Video" type="video" />
