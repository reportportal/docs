...
<media-view src={require('./img/widget-types/ComponentHealthCheckTableBuild.png')} alt="ComponentHealthCheckTableBuild" />
...
<media-view src={require('./img/widget-types/ComponentHealthCheckTableFeature.png')} alt="ComponentHealthCheckTableFeature" />

Widget logic is the same as for [Component health check](./ComponentHealthCheck).

<media-view thumbnail={require('./img/widget-types/ComponentHealthCheckTableBuild.png')} src="https://youtu.be/uRCpA7zivZU" alt="ComponentHealthCheckTableBuild" type="video" />
