...
description: Analyze component health in detailed table format. Track passing rates, defect distribution, and custom metrics across application components using qa dashboard tools.
---
