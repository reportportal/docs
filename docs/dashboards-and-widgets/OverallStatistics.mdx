...
<media-view src={require('./img/widget-types/PanelView.png')} alt="Dashboard to manage test results: Overall statistics" />

or Donut view.

<media-view src={require('./img/widget-types/DonutView.png')} alt="Overall Statistics Donut View" />
