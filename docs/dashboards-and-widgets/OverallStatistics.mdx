...
<MediaViewer src={require('./img/widget-types/OverallStatistics1.png')} alt="Dashboard to manage test results: Overall statistics" />

or Donut view.

<MediaViewer src={require('./img/widget-types/OverallStatistics2.png')} alt="Overall Statistics Donut View" />
