...
To assign user to the project on the "All Users" page, perform the following
steps:
...
<MediaViewer src="https://youtu.be/SPsn1Pw3Tno" alt="Edit Project Role From All Users page" type="video" />
...
<MediaViewer src="https://youtu.be/T5PYG91iygU" alt="Delete User" type="video" />
