...
<media-view src={require('./img/azure-saml/AzureSAML21.png')} alt="Administrate section in our test automation reporting platform" />

3. Select ```Plugins```.

<media-view src={require('./img/azure-saml/AzureSAML22.png')} alt="Plugins section in our continuous testing platform" />
...
<media-view src={require('./img/azure-saml/SAMLIntegration.png')} alt="Configure Azure SAML in our test automation dashboard" />
