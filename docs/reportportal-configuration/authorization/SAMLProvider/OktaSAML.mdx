...
<MediaViewer thumbnail={require('./img/OktaSAML.png')} src="https://youtu.be/ljXvCVWG4mQ" alt="Okta SAML authorization in our open source test reporting tool" type="video" />
