...
<MediaViewer thumbnail={require('./img/ProjectSettingsGeneral.png')} src="https://youtu.be/ih-ECyC29f0" alt="Project settings in our real time dashboard open source" type="video" />
...
:::
<MediaViewer thumbnail={require('./img/CustomDefectTypes.png')} src="https://youtu.be/CcU2_dEu59k" alt="Defect Type Configuration for clear test execution report" type="video" />
...
<MediaViewer thumbnail={require('./img/DemoData.png')} src="https://youtu.be/bXHY0_sXAF8" alt="Generate Demo Data with test report&analytics dashboard" type="video" />
...
<MediaViewer thumbnail={require('./img/InviteUserProjectMembers.png')} src="https://youtu.be/VOk80XZHpWc" alt="Invite User From Project Members Page" type="video" />
...
<MediaViewer thumbnail={require('./img/EditProjectRole.png')} src="https://youtu.be/DF38BbE5vws" alt="Edit Project Role From Project Members Page" type="video" />
