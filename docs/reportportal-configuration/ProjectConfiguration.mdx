...
ReportPortal allows you to control the amount of the stored data (launches, test items, logs and attachments) by removing outdated elements using Quartz jobs.
...
<media-view thumbnail={require('./img/managingProjects/GeneralConf.png')} src="https://youtu.be/GsBGyhj-V6s" alt="Manage project General Config" type="video" />
...
<media-view thumbnail={require('./img/managingProjects/DefectTypesConf.png')} src="https://youtu.be/z8iWXXk6A6Q" alt="Defect Type Configuration" type="video" />
...
<media-view thumbnail={require('./img/managingProjects/DemoData.png')} src="https://youtu.be/YGBZfCvfdVw" alt="Demo Data" type="video" />
