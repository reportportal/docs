...
* by [Unique ID](./UniqueId) ***(deprecated/ will be replaced by Test Case ID gradually)***
...
* [UUID](./UniqueId) ***(deprecated/ will be replaced by Test Case ID gradually)***
...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/m_SkXKgc6NE" alt="History Table of launches in our test execution dashboard" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryTableSameName.png')} src="https://youtu.be/DoKW0jFBELo" alt="History Table launches with the same name" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/CompareLaunchResults.png')} src="https://youtu.be/trv2f5g62Is" alt="Compare results of a launch with the filter" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoricalLineOfExecutions.png')} src="https://youtu.be/YFzorxQO_S0" alt="History Line ToolTip in our real time dashboard open source" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/TestItemActionsHistory.png')} src="https://youtu.be/X5u_6rI5V8k" alt="Action History" type="video" />
