...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/WYytkzpzJps" alt="HistoryTable" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/Y5eXSa3bA8w" alt="HistoryTable" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/hr4IQ5UBpM8" alt="HistoryTable" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryLineToolTip.png')} src="https://youtu.be/P0S1zElmWx0" alt="HistoryLineToolTip" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/actionHistory.png')} src="https://youtu.be/Z-gPwjxWHTQ" alt="actionHistory" type="video" />
