...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/WYytkzpzJps" alt="History Table regression" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryLineToolTip.png')} src="https://youtu.be/P0S1zElmWx0" alt="History Line ToolTip" type="video" />
