...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/WYytkzpzJps" alt="History Table of launches in our test execution dashboard" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/Y5eXSa3bA8w" alt="History Table launches with the same name" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryTable.png')} src="https://youtu.be/hr4IQ5UBpM8" alt="Compare results of a launch with the filter" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/HistoryLineToolTip.png')} src="https://youtu.be/P0S1zElmWx0" alt="History Line ToolTip in our real time dashboard open source" type="video" />
...
<media-view thumbnail={require('./img/history-of-launches/ActionHistory.png')} src="https://youtu.be/Z-gPwjxWHTQ" alt="Action History" type="video" />
