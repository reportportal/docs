...
For example, there are the following custom defect types that are created on the project:

**Product Bug Group** – Team 1, Team 2, Billing feature, Backend bug, UI issue, Not implemented feature
