...
<media-view thumbnail={require('./img/manage-launches/edit_launch.png')} src="https://youtu.be/87dTCdsFD-I" alt="edit_launch" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/edit_item.png')} src="https://youtu.be/7PZIowd9III" alt="edit_item" type="video" />
...
<media-view src={require('./img/manage-launches/MergeBasicModel.png')} alt="MergeBasicModel" />
...
<media-view src={require('./img/manage-launches/MergeScheme.png')} alt="MergeScheme" />
...
<media-view thumbnail={require('./img/manage-launches/merge.png')} src="https://youtu.be/tGTGFO0cGCM" alt="merge" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/compare_launches.png')} src="https://youtu.be/1MjgTxbRH5c" alt="compare_launches" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/move_to_debug-launches.png')} src="https://youtu.be/UW1oMNy1-qo" alt="move_to_debug-launches" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/force_finish.png')} src="https://youtu.be/nI1u4ZvKX1Y" alt="force_finish" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/export_launch.png')} src="https://youtu.be/NZIolEFI7zc" alt="export_launch" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/delete_launch.png')} src="https://youtu.be/DNy9aqPz3NQ" alt="delete_launch" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/delete_items.png')} src="https://youtu.be/r2r5OHwVt-U" alt="delete_items" type="video" />
