...
<media-view thumbnail={require('./img/manage-launches/EditLaunch.png')} src="https://youtu.be/87dTCdsFD-I" alt="Edit Launch" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/Merge.png')} src="https://youtu.be/tGTGFO0cGCM" alt="Merge Launches" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/ExportLaunch.png')} src="https://youtu.be/NZIolEFI7zc" alt="Export Launch" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/DeleteLaunch.png')} src="https://youtu.be/DNy9aqPz3NQ" alt="Delete launch" type="video" />
