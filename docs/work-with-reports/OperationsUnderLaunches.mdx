...
<media-view thumbnail={require('./img/manage-launches/EditLaunch.png')} src="https://youtu.be/XRjtJ8Dq468" alt="Edit Launch in our test automation reporting dashboard" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/EditTestItem.png')} src="https://youtu.be/mGhwWwq_R3g" alt="Edit Item" type="video" />
...
:::
<media-view thumbnail={require('./img/manage-launches/MergeLaunches.png')} src="https://youtu.be/oOyuiYEZLnQ" alt="Merge Launches in our centralized test automation tool" type="video" />
...
:::
<media-view thumbnail={require('./img/manage-launches/CompareLaunches.png')} src="https://youtu.be/bfLVTKIHf7U" alt="Compare Launches" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/MoveLaunchesToDebug.png')} src="https://youtu.be/-DBDmyWEQ5A" alt="Move launches to Debug" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/ForceFinish.png')} src="https://youtu.be/rRyfktuvhH0" alt="Force finish" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/ExportLaunches.png')} src="https://youtu.be/3AvmRyrh8f4" alt="Export Launch in our real time dashboard open source" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/DeleteLaunches.png')} src="https://youtu.be/_KQk6qgc1g0" alt="Delete launch in our test reporting tool" type="video" />
...
<media-view thumbnail={require('./img/manage-launches/DeleteTestItem.png')} src="https://youtu.be/w6wFP86bvJQ" alt="Delete Items" type="video" />
