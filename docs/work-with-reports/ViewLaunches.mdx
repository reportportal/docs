...
<media-view thumbnail={require('./img/view-launches/NavigateToItems.png')} src="https://youtu.be/1QWmSH_brVg" alt="Viewing data in our test report dashboard" type="video" />
...
<media-view thumbnail={require('./img/view-launches/LogView.png')} src="https://youtu.be/_g0GW16sXGU" alt="Log Messages in our automated testing tool" type="video" />
...
<media-view thumbnail={require('./img/view-launches/Attachments.png')} src="https://youtu.be/nMSSAcqrfC0" alt="Screenshot Gallery" type="video" />
...
<media-view src={require('./img/view-launches/LogViewForContainers1.png')} alt="Log view for container - launch" />

<media-view src={require('./img/view-launches/LogViewForContainers2.png')} alt="Launch Logs" />

## Nested Steps

<media-view thumbnail={require('./img/view-launches/NestedSteps.png')} src="https://youtu.be/t6kvmpwZE8Y" alt="Nested Steps" type="video" />

## Retried test case (retry)

[How can I report retry items](/dev-guides/RetriesReporting)
...
<media-view src={require('./img/view-launches/RetriedTestCase1.png')} alt="Retry Launch Level" />

On a step view, you can see the number of invocations and stack trace of each invocation.

<media-view src={require('./img/view-launches/RetriedTestCase2.png')} alt="Retry Step Level" />

On a log view, you can see the number of invocations and logs, attachments of each invocation.

<media-view src={require('./img/view-launches/RetriedTestCase3.png')} alt="Retry Log Level" />
