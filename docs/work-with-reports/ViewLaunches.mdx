...
<media-view thumbnail={require('./img/view-launches/viewing_data.png')} src="https://youtu.be/CjfZYY1ulZY" alt="viewing_data" type="video" />
...
<media-view thumbnail={require('./img/view-launches/logMessages.png')} src="https://youtu.be/WXOzhiTIfIE" alt="logMessages" type="video" />
...
<media-view thumbnail={require('./img/view-launches/screenshotGallery.png')} src="https://youtu.be/83k5x73JDI0" alt="screenshotGallery" type="video" />
...
<media-view src={require('./img/view-launches/LaunchLogLevel.png')} alt="Launch Logs" />

<media-view src={require('./img/view-launches/LaunchLogs.png')} alt="Launch Logs" />

## Nested Steps

<media-view thumbnail={require('./img/view-launches/NestedSteps.png')} src="https://youtu.be/6CEBJnkOHY8" alt="NestedSteps" type="video" />
...
<media-view src={require('./img/view-launches/RetryLaunchLevel.png')} alt="RetryLaunchLevel" />

On a step view, you can see the number of invocations and stack trace of each invocation.

<media-view src={require('./img/view-launches/RetryStepLevel.png')} alt="RetryStepLevel" />

On a log view, you can see the number of invocations and logs, attachments of each invocation.

<media-view src={require('./img/view-launches/RetryLogLevel.png')} alt="RetryStepLevel" />
