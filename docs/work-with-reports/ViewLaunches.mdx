...
<media-view thumbnail={require('./img/view-launches/ViewingData.png')} src="https://youtu.be/CjfZYY1ulZY" alt="Viewing data" type="video" />
...
<media-view thumbnail={require('./img/view-launches/LogMessages.png')} src="https://youtu.be/WXOzhiTIfIE" alt="Log Messages" type="video" />
