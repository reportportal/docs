...
<MediaViewer thumbnail={require('./img/view-launches/NavigateToItems.png')} src="https://youtu.be/1QWmSH_brVg" alt="Viewing data in our test report dashboard" type="video" />
...
<MediaViewer thumbnail={require('./img/view-launches/LogView.png')} src="https://youtu.be/_g0GW16sXGU" alt="Log Messages in our automated testing tool" type="video" />
...
<MediaViewer thumbnail={require('./img/view-launches/Attachments.png')} src="https://youtu.be/nMSSAcqrfC0" alt="Screenshot Gallery" type="video" />
...
<MediaViewer thumbnail={require('./img/view-launches/NestedSteps.png')} src="https://youtu.be/t6kvmpwZE8Y" alt="Nested Steps" type="video" />
