...
<media-view thumbnail={require('./img/filtering-launches/LaunchLevelFilters.png')} src="https://youtu.be/Rk5khFVwowI" alt="Launch Level Filters in our qa automation dashboard" type="video" />
...
<media-view thumbnail={require('./img/filtering-launches/StepLevelFilters.png')} src="https://youtu.be/S4aViEIurn4" alt="Step Level Filters in our test reporting tool" type="video" />
