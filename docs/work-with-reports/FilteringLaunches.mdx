...
<media-view thumbnail={require('./img/filtering-launches/launchLevelFilters.png')} src="https://youtu.be/Rk5khFVwowI" alt="launchLevelFilters" type="video" />
...
<media-view thumbnail={require('./img/filtering-launches/stepLevelFilters.png')} src="https://youtu.be/S4aViEIurn4" alt="stepLevelFilters" type="video" />
