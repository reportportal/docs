...
<media-view thumbnail={require('./img/filtering-launches/LaunchLevelFilters.png')} src="https://youtu.be/b28ulSB4Wq0" alt="Launch Level Filters in our qa automation dashboard" type="video" />
...
<media-view thumbnail={require('./img/filtering-launches/StepLevelFilters.png')} src="https://youtu.be/rTDWrkaBM9k" alt="Step Level Filters in our test reporting tool" type="video" />
