...
>
<media-view thumbnail={require('./img/jira/JiraProject.png')} src="https://youtu.be/med4tuL4plU" alt="JiraProject" type="video" />
...
<media-view thumbnail={require('./img/jira/JiraProject.png')} src="https://youtu.be/tCRh30KDpKc" alt="ProjectJiraIntegration" type="video" />
...
<media-view src={require('./img/jira/PostIssue.png')} alt="Post issue" />
...
<media-view src={require('./img/jira/LinkIssue.png')} alt="Link issue" />
