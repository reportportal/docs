...
* Notification plugins: E-mail server, Slack
...
|E-mail server/Slack| With this plugin, you will be able to configure notifications about test result finish in real time.|
