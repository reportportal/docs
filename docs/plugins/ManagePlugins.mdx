...
<MediaViewer thumbnail={require('./img/UploadPlugin.png')} src="https://youtu.be/xR75Bdq3uaM" alt="Upload Plugin to our open source test reporting tool" type="video" />
...
<MediaViewer thumbnail={require('./img/DisablePlugin.png')} src="https://youtu.be/Sj9BpnTIxW8" alt="Enable/Disable Plugin" type="video" />
...
* [integration with Atlassian Jira Server](./AtlassianJiraServer)
* [integration with Atlassian Jira Cloud](./AtlassianJiraCloud)
