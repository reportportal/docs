...
* [integration with Jira Server](/plugins/AtlassianJiraServer)
* [integration with Jira Cloud](/plugins/AtlassianJiraCloud)
* [integration with Azure DevOps](/plugins/AzureDevOps)
* [integration with GitLab](/plugins/GitLab)
* [integration with Monday](/plugins/Monday)
...
* [integration with Slack](/plugins/Slack)
* [integration with Telegram](/plugins/Telegram)
...
* [integration with JUnit](/plugins/JUnit)
* [integration with RobotFramework](/plugins/RobotFramework)
