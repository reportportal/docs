...
<media-view thumbnail={require('./img/UploadPlugin.png')} src="https://youtu.be/xR75Bdq3uaM" alt="Upload Plugin" type="video" />
...
* [integration with LDAP](/report-poral-configuration/authorization/LDAP)
* [integration with Active directory](/report-poral-configuration/authorization/ActiveDirectory)
* [integration with Okta SAML](/report-poral-configuration/authorization/SAML/OktaSAML)
* [integration with Azure SAML](/report-poral-configuration/authorization/SAML/AzureSAML)
