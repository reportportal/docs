...
<media-view thumbnail={require('./img/UploadPlugin.png')} src="https://youtu.be/xR75Bdq3uaM" alt="UploadPluginVideo" type="video" />
...
<media-view thumbnail={require('./img/DisablePlugin.png')} src="https://youtu.be/Sj9BpnTIxW8" alt="Enable/DisablePluginVideo" type="video" />
