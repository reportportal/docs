...
<media-view thumbnail={require('./img/sauce-labs/SauceLabs.png')} src="https://youtu.be/RQAxGz6koh0" alt="How to use Sauce Labs Integration with our centralized test automation tool" type="video" />
