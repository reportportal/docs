...
<media-view thumbnail={require('./img/jira/JiraGlobal.png')} src="https://youtu.be/tCRh30KDpKc" alt="Global Jira Integration Creation" type="video" />
...
>
<media-view thumbnail={require('./img/jira/JiraProject.png')} src="https://youtu.be/med4tuL4plU" alt="Global Integration Jira and Post Issue in our test reporting tool" type="video" />
...
<media-view thumbnail={require('./img/jira/JiraGlobal.png')} src="https://youtu.be/yvYwxs4zTYA" alt="Edit Global Jira Integration" type="video" />
...
<media-view thumbnail={require('./img/jira/JiraGlobal.png')} src="https://youtu.be/mEWP4txdJFA" alt="Remove Global Jira Integration" type="video" />
...
<media-view thumbnail={require('./img/jira/JiraProject.png')} src="https://youtu.be/tCRh30KDpKc" alt="Project Jira Integration" type="video" />
...
<media-view thumbnail={require('./img/jira/JiraGlobal.png')} src="https://youtu.be/KIrEVY-DKiA" alt="Reset to Global Jira Integration" type="video" />
...
<media-view src={require('./img/jira/PostIssue.png')} alt="Post issue in Jira Server" />
...
<media-view src={require('./img/jira/LinkIssue.png')} alt="Link issue in Jira Server" />
