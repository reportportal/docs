...
<MediaViewer thumbnail={require('./img/gitlab/GitLab1.png')} src="https://youtu.be/O-Y9y_C7a6k" alt="Global GitLab BTS integration" type="video" />
...
<MediaViewer thumbnail={require('./img/gitlab/GitLab8.png')} src="https://youtu.be/tbkd_DjW3Ok" alt="Project GitLab BTS integration" type="video" />
...
<MediaViewer thumbnail={require('./img/gitlab/GitLab14.png')} src="https://youtu.be/Ydh_Zrvpglg" alt="GitLab plugin. Post issue" type="video" />
...
<MediaViewer thumbnail={require('./img/gitlab/GitLab19.png')} src="https://youtu.be/Ydh_Zrvpglg" alt="GitLab plugin. Link issue" type="video" />
...
<MediaViewer thumbnail={require('./img/gitlab/GitLab21.png')} src="https://youtu.be/QR-2X2Ka9jM" alt="GitLab plugin. Unlink issue" type="video" />
