...
You can integrate our centralized test automation tool with an E-mail server. With this integration, you will be able to perform such functions as:
...
<media-view thumbnail={require('./img/e-mail-server/EmailServer.png')} src="https://youtu.be/FekmJRNedfU" alt="E-mail server configuration on our qa automation dashboard" type="video" />
