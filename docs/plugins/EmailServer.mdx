...
<MediaViewer thumbnail={require('./img/e-mail-server/EmailServer.png')} src="https://youtu.be/FekmJRNedfU" alt="E-mail server configuration on our qa automation dashboard" type="video" />
