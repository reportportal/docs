...
You can integrate the ReportPortal with an E-mail server. With this integration, you will be able to perform such functions as:
...
<media-view thumbnail={require('./img/e-mail-server/EmailServer.png')} src="https://youtu.be/FekmJRNedfU" alt="E-mail server configuration" type="video" />
