...
To install the Atlassian Jira Cloud plugin, see [Upload plugin](/plugins/ManagePlugins#upload-plugin) section.
...
## Link an issue with an issue in  Atlassian Jira Cloud
