...
<media-view src={require('./img/rally/PostIssueRally.png')} alt="Post issue to Rally from our test results dashboard" />
...
<media-view src={require('./img/rally/LinkIssueRally.png')} alt="Link issue in Rally" />
