...
<media-view src={require('./img/jira/JiraCloudIntegrationCreation.png')} alt="Global Jira Integration Creation" />
...
<media-view src={require('./img/jira/PostIssueJiraCloud.png')} alt="Post Issue in Jira Cloud in our test results dashboard" />
...
<media-view src={require('./img/jira/LinkIssueJiraCloud.png')} alt="Link issue in Jira Cloud" />
