...
description: Investigate test failures by setting defect types, linking bug tracking systems, and performing detailed test failure analysis for better quality control.
---
...
Using [“Make decision” modal](../analysis/ManualAnalysis.mdx#make-decision-modal-redesign), you can choose the real reason of your failure and provide a comment for this fail.

:::info
Admin, Manager, and user with edit permissions can set defect type.
:::
...
:::info
Admin, Manager, and user with edit permissions can create custom defect type.
:::
...
<MediaViewer src={require('./img/defect-types/CustomDefectTypes1.png')} alt="Create a custom defect types in our test results dashboard" />
...
<MediaViewer src={require('./img/defect-types/CustomDefectTypes2.png')} alt="Custom defect types in our test automation dashboard" />

<MediaViewer src={require('./img/defect-types/CustomDefectTypes3.png')} alt="Example of using custom defect types in our test automation results dashboard" />
