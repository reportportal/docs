...
* AGENTIC – launches reported by [AI agents](../test-results-reporting/AgenticTestResults.md).
* AUTOMATION - launches reported via [Test frameworks integrations](../integrations/test-frameworks/index.mdx).
...
:::info
Admin, Manager, and user with edit permissions can change status on Step and Log level.
:::
...
[How can I report retry items](../developers-and-api/RetriesReporting.mdx)
