...
* AGENTIC – launches reported by [AI agents](../../test-results-reporting/AgenticTestResults).
* AUTOMATION - launches reported via [Test frameworks integrations](../../integrations/test-frameworks/).
...
[How can I report retry items](../../developers-and-api/RetriesReporting)
