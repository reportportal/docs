...
<media-view src={require('./img/analyzer/api-analyzer.png')} alt="api-analyzer" />
...
<media-view src={require('./img/analyzer/exchange.png')} alt="exchange" />

## Declaring queues

Each analyzer has to declare 5 queues with names: `analyze`, `search`, `index`, `clean`, `delete`.

<media-view src={require('./img/analyzer/queues.png')} alt="queues" />
