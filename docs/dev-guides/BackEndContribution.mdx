...
<media-view src={require('./img/backend/IdeaFormatter.png')} alt="Idea Formatter" />
...
<media-view src={require('./img/backend/AuthDbConfig.png')} alt="Start Service Authorization" />

<media-view src={require('./img/backend/AuthBinaryConfig.png')} alt="Values you should fill" />
...
As the result our `docker-compose.yml` should be like [this](img/backend/DockerCompose.yml)

To start up Service API you should fill marked values in the `application.yaml` file:

<media-view src={require('./img/backend/AuthDbConfig.png')} alt="Start Service API" />

<media-view src={require('./img/backend/AuthBinaryConfig.png')} alt="Authorization binary Configuration" />

<media-view src={require('./img/backend/RabbitmqConfig.png')} alt="Rabbitmq Configuration" />
...
<media-view src={require('./img/backend/AuthDbConfig.png')} alt="Start Service Jobs" />

<media-view src={require('./img/backend/AuthBinaryConfig.png')} alt="Values for binary" />

<media-view src={require('./img/backend/RabbitmqConfig.png')} alt="Values for Rabbitmq" />
...
<media-view src={require('./img/backend/CommitHash.png')} alt="Commit hash" />
...
<media-view src={require('./img/backend/BuildGradleUpdated.png')} alt="Build gradle updated" />
