...
<media-view src={require('./img/rerun/Tests.png')} alt="Tests example" />

After run we can see few failed items:

<media-view src={require('./img/rerun/LaunchFailed1.png')} alt="Launch failed" />

<media-view src={require('./img/rerun/LaunchFailed2.png')} alt="Failed test items" />
...
<media-view src={require('./img/rerun/LaunchFailed2.png')} alt="Launch test results" />

<media-view src={require('./img/rerun/LaunchFailedRp2.png')} alt="Test results Launch failed" />
...
<media-view src={require('./img/rerun/RpRerun1.png')} alt="Report the same launches using rerun" />

We have only one launch with last run data

<media-view src={require('./img/rerun/RpRerunStepView.png')} alt="Rerun Step View" />
...
To start launch rerun you should call [default start launch endpoint](./ReportingDevelopersGuide#start-launch) adding `"rerun"=true` parameter in the request body.
...
To start launch rerun you should call [default start launch endpoint](./ReportingDevelopersGuide#start-launch) adding `"rerun"=true` and `"rerunOf"=launch_uuid` parameters in the request body. Where `launch_uuid` is UUID of launch that have to be reruned.
