...
<media-view src={require('./img/rerun/tests.png')} alt="tests" />

After run we can see few failed items:

<media-view src={require('./img/rerun/launch_failed_1.png')} alt="launch_failed_1" />

<media-view src={require('./img/rerun/launch_failed_2.png')} alt="launch_failed_2" />
...
<media-view src={require('./img/rerun/launch_failed_rp_2.png')} alt="launch_failed_rp_2" />
...
<media-view src={require('./img/rerun/rp_rerun_1.png')} alt="rp_rerun_1" />

We have only one launch with last run data

<media-view src={require('./img/rerun/rp_rerun_step_view.png')} alt="rp_rerun_step_view" />
