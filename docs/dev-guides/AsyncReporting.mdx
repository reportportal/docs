...
<media-view src={require('./img/async/simple-scheme.png')} alt="simple-scheme" />
...
<media-view src={require('./img/async/exchanges-queues.png')} alt="exchanges-queues" />
...
<media-view src={require('./img/async/uuid-queus-mapping.png')} alt="uuid-queus-mapping" />
...
<media-view src={require('./img/async/finish-launch.png')} alt="finish-launch" />
