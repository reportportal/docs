...
<media-view src={require('./img/attachments/AttachmentsGuide1.png')} alt="Image Attachment in our test reporting tool" />

An example of file attachment:

<media-view src={require('./img/attachments/AttachmentsGuide2.png')} alt="File Attachment in our open source test reporting tool" />

<media-view src={require('./img/attachments/AttachmentsGuide3.png')} alt="Attachment Details in our multi-language test reporting tool" />
