---
sidebar_position: 2
sidebar_label: Version 25.1.11
---

# Version 25.1.11

## 1. Bugs fixed:
Jira Cloud Hover: Fixed 400 error on Issue ID hover — tooltip now shows SUMMARY / STATUS.
Jira Cloud Post Issue: Fixed 400 error when using Linked Issues or Affects version — issues post successfully with correct UI feedback.

## 2. Released services and plugins:
|Plugin Name|Repository|Tag|
|---|---| --- |
|Jira Cloud|reportportal/plugin-bts-jira-cloud|5.13.6|
