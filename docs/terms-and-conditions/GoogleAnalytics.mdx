...
<media-view src={require('./img/ga2.png')} alt="ga2" />
...
<media-view src={require('./img/ga3.png')} alt="ga3" />

3. Select “Server Settings”.

<media-view src={require('./img/ga4.png')} alt="ga4" />

4. Open “Analytics” tab.

5. Uncheck “Help make ReportPortal better by automatically sending analytics to us” checkbox.

<media-view src={require('./img/ga5.png')} alt="ga5" />
...
<media-view src={require('./img/ga1.png')} alt="ga1" />
