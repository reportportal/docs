...
<media-view thumbnail={require('./img/ImportViaAPI.png')} src="https://youtu.be/gCBDlX6dlEE" alt="Import via API on our test automation results dashboard" type="video" />
