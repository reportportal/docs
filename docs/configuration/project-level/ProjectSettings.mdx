...
- **Name** – is a disabled field, can be edited on Organization level -> [Projects page](/configuration/organization-level/Projects).
...
Integrations can be added at the [instance level](/configuration/instance-level/Plugins), making them applicable to all projects, or they can be configured specifically for a project in the Project Settings.
...
:::tip
To use this functionality, ensure that the Slack plugin is uploaded and enabled. For that, go to the instance level -> [Plugins page](/configuration/instance-level/Plugins).
:::
