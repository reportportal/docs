...
The first one is API service back-end environment variables that are described in [ReportPortal jobs configuration](../../../installation-and-deployment/advanced-installation/JobsConfiguration).

The second one is the "General" tab you can configure parameter of data storage in ReportPortal for this project:

- **Name** – is a disabled field, can be edited on Organization level -> [Projects page](../../organization-level/Projects).
...
Integrations can be added at the [instance level](../../instance-level/Plugins), making them applicable to all projects, or they can be configured specifically for a project in the Project Settings.
...
:::tip
To use this functionality, ensure that the Slack plugin is uploaded and enabled. For that, go to the instance level -> [Plugins page](../../instance-level/Plugins).
:::
...
**Webhook URL** – mandatory field (it is configured on the [Slack side](../../../integrations/notifications/Slack#configuration-on-slack-side)
...
**Chat id** – mandatory field, copied from group info in [Telegram](../../../integrations/notifications/Telegram#configuration-on-telegram-side)

:::important
Add ‘-’ before the chat id.
:::

**Bot Api Key** - mandatory field, received during registration [your Telegram bot](../../../integrations/notifications/Telegram#configuration-on-telegram-side)
...
Explore the full capabilities of [Quality Gates](../../../analysis/quality-gates/).
