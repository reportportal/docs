---
sidebar_label: Instance level
description: Configure ReportPortal at the instance level. Manage organizations, users, server settings, and plugins for the whole test reporting platform.
---

# Instance level

Instance-level configuration applies to the entire ReportPortal installation. It is intended for Admins who need to control how the platform is structured, who can access it, and which integrations are available for test reporting across all organizations and projects.
