...
description: Configure organization-level settings in ReportPortal. Manage projects, users, roles, and data retention for test reporting across the organization.
---

# Organization level

Organization-level configuration applies to all projects grouped under one organization. It is intended for Admins and Managers who need a shared structure for teams, access, and how long test data is stored.
