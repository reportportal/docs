...
<MediaViewer thumbnail={require('./img/QualityGatesCreation.png')} src="https://youtu.be/dXp3Lf9bI30" alt="Quality Gate Creation in our real time dashboard open source" type="video" />
...
<MediaViewer thumbnail={require('./img/AmountOfTestsALL.png')} src="https://youtu.be/TC0J8BV_XBY" alt="Rule: Amount of All Tests in the launch" type="video" />
...
<MediaViewer thumbnail={require('./img/AmountAttribute.png')} src="https://youtu.be/EwsG7RcmcDs" alt="Rule: Amount of Tests with attributes in the launch" type="video" />
...
<MediaViewer thumbnail={require('./img/FailureRateAll.png')} src="https://youtu.be/bSO21gtT82E" alt="Failure Rate" type="video" />
...
<MediaViewer thumbnail={require('./img/Issues.png')} src="https://youtu.be/ajIvWB83bGg" alt="Rule: Issues in the run" type="video" />
...
<MediaViewer thumbnail={require('./img/NewFailure.png')} src="https://youtu.be/W05N7DQkalg" alt="Rule: New Failure" type="video" />
...
<MediaViewer thumbnail={require('./img/NewErrors/NewErrors6.png')} src="https://youtu.be/sfEk9DuuEVQ" alt="Defining New Errors in the run in our test automation dashboard" type="video" />
