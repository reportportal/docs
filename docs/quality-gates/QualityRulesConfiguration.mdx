...
<media-view thumbnail={require('./img/Quality Gates Creation.png')} src="https://youtu.be/dXp3Lf9bI30" alt="Quality Gate Creation" type="video" />
...
<media-view thumbnail={require('./img/Amount of tests ALL.png')} src="https://youtu.be/TC0J8BV_XBY" alt="Rule: Amount of All Tests in the launch" type="video" />
...
<media-view thumbnail={require('./img/Amount Attribute.png')} src="https://youtu.be/EwsG7RcmcDs" alt="Rule: Amount of Tests with attributes in the launch" type="video" />
...
<media-view thumbnail={require('./img/Failure Rate All.png')} src="https://youtu.be/bSO21gtT82E" alt="Failure Rate" type="video" />
...
<media-view thumbnail={require('./img/New failure.png')} src="https://youtu.be/W05N7DQkalg" alt="Rule: New Failure" type="video" />
...
<media-view src={require('./img/Baseline Latest.png')} alt="Rule: Baseline Latest" />
...
<media-view src={require('./img/Custom Baseline.png')} alt="Rule: Baseline Custom" />
...
<media-view src={require('./img/NewErrors/new-errors-rule1.png')} alt="New errors in the run" />

5) Enter ```Quality Gate Name``` and ```Analyzed Launch```, then click ```Save``` button.

<media-view src={require('./img/NewErrors/new-errors-rule2.png')} alt="New errors in the run" />
...
<media-view src={require('./img/NewErrors/new-errors-rule3.png')} alt="New errors in the run" />
...
<media-view src={require('./img/NewErrors/new-errors-rule4.png')} alt="New errors in the run" />

<media-view src={require('./img/NewErrors/new-errors-rule5.png')} alt="New errors in the run" />

Before running automation tests, make sure that **“Quality Gates”** feature is ON.

<media-view src={require('./img/NewErrors/new-errors-rule6.png')} alt="New errors in the run" />
...
<media-view src={require('./img/NewErrors/new-errors-rule7.png')} alt="New errors in the run" />
...
<media-view src={require('./img/NewErrors/new-errors-rule8.png')} alt="New errors in the run" />

12) To look at the failed test results, click on the ```Failed``` status and then click on the number under ```Current``` column.

<media-view src={require('./img/NewErrors/new-errors-rule9.png')} alt="New errors in the run" />
...
<media-view src={require('./img/NewErrors/new-errors-rule10.png')} alt="New errors in the run" />
...
<media-view src={require('./img/NewErrors/new-errors-rule11.png')} alt="New errors in the run" />

<media-view src={require('./img/NewErrors/new-errors-rule12.png')} alt="New errors in the run" />

Follow the steps below depending on the preferable settings for the Baseline Launch.

<media-view src={require('./img/NewErrors/new-errors-rule13.png')} alt="New errors in the run" />

<media-view src={require('./img/NewErrors/new-errors-rule14.png')} alt="New errors in the run" />
