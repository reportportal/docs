...
<media-view thumbnail={require('./img/NewErrors/NewErrors6.png')} src="https://youtu.be/sfEk9DuuEVQ" alt="Defining New Errors in the run in our test automation dashboard" type="video" />
