...
[![Quality Gate Creation](img/Quality%20Gates%20Creation.png)](https://youtu.be/dXp3Lf9bI30)
...
[![Rule: Amount of All Tests in the launch](img/Amount%20of%20tests%20ALL.png)](https://youtu.be/TC0J8BV_XBY)
...
[![Rule: Amount of Tests with attributes in the launch](img/Amount%20Attribute.png)](https://youtu.be/EwsG7RcmcDs)
...
[![Rule: Percent of Tests](img/Failure%20Rate%20All.png)](https://youtu.be/bSO21gtT82E)
...
[![Rule: Issues in the run](img/Issues.png)](https://youtu.be/ajIvWB83bGg)
...
[![Rule: New Failure](img/New%20failure.png)](https://youtu.be/W05N7DQkalg)
...
![Rule: Baseline Latest](img/Baseline%20Latest.png)
...
![Rule: Baseline Custom](img/Custom%20Baseline.png)
...
![ImageName](img/NewErrors/new-errors-rule1.png)

5) Enter ```Quality Gate Name``` and ```Analyzed Launch```, then click ```Save``` button.

![ImageName](img/NewErrors/new-errors-rule2.png)
...
![ImageName](img/NewErrors/new-errors-rule3.png)
...
![ImageName](img/NewErrors/new-errors-rule4.png)

![ImageName](img/NewErrors/new-errors-rule5.png)

Before running automation tests, make sure that **“Quality Gates”** feature is ON.

![ImageName](img/NewErrors/new-errors-rule6.png)
...
![ImageName](img/NewErrors/new-errors-rule7.png)
...
![ImageName](img/NewErrors/new-errors-rule10.png)
...
![ImageName](img/NewErrors/new-errors-rule11.png)

![ImageName](img/NewErrors/new-errors-rule12.png)

Follow the steps below depending on the preferable settings for the Baseline Launch.

![ImageName](img/NewErrors/new-errors-rule13.png)

![ImageName](img/NewErrors/new-errors-rule14.png)
...
[![Report](img/ReportThatIsAlreadySent.png)](https://youtu.be/W7BBhni9ANU)
