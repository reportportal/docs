...
<MediaViewer thumbnail={require('./img/ReportThatIsAlreadySent.png')} src="https://youtu.be/W7BBhni9ANU" alt="Quality Gates in CI/CD and our continuous testing platform" type="video" />
