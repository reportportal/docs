...
description: Understand Quality Gates purpose and benefits for quality control in ReportPortal test automation reporting tools.
---
...
<MediaViewer src={require('./img/QualityGatesIntro.jpg')} alt="Quality Gates Intro" />
