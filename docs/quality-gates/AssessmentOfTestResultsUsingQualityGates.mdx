...
<media-view src={require('./img/Quality Gates Report.png')} alt="Quality Gates Report" />
...
<media-view src={require('./img/ReportThatIsAlreadySent.png')} alt="ReportThatIsAlreadySent" />
...
<media-view src={require('./img/Quality Gates Auto.png')} alt="Quality Gates Auto" />
