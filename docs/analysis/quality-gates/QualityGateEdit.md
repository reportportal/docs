...
If you want to recalculate Quality Gate with a new values, please check the  section [How to recalculate Quality Gates](./AssessmentOfTestResultsUsingQualityGates.mdx#how-to-recalculate-quality-gates).
