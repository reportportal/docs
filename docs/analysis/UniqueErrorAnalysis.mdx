...
4. The [‘New Errors’](./quality-gates/QualityRulesConfiguration.mdx#new-errors-in-the-run) Quality Gates rule.
...
Unique Error analysis functionality can be extended by the [ReportPortal premium feature](https://reportportal.io/pricing/saas) – [Quality Gates](./quality-gates/index.md).
