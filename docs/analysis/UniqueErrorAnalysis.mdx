...
<media-view thumbnail={require('./img/UniqueErrorAnalysis/UniqueErrorVideo.png')} src="https://youtu.be/mOssRH7ZxUM" alt="Video of Unique Error functionality" type="video" />
