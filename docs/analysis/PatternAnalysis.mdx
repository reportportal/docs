...
As a result, when both AA and Auto Pattern Analysis occur, a test item will have two labels: AA and PA.

<MediaViewer src={require('./img/PatternAnalysis/PatternAnalysis11.png')} alt="Run Pattern Analysis manually" />
