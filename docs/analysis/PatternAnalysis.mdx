...
<media-view src={require('./img/PatternAnalysis/PatternAnalysisString2.png')} alt="Pattern Analysis String in the logs" />

**Regex** – regular expression.

<media-view src={require('./img/PatternAnalysis/PatternAnalysisRegex1.png')} alt="Pattern Analysis Regex rule" />

<media-view src={require('./img/PatternAnalysis/PatternAnalysisRegex2.png')} alt="Pattern Analysis Regex in the logs" />
...
<media-view thumbnail={require('./img/AutoPattern.png')} src="https://youtu.be/5YaN85x6_hc" alt="Pattern Analysis launched Automatically" type="video" />
...
<media-view thumbnail={require('./img/ManualPattern.png')} src="https://youtu.be/XgJr5Nm7OrI" alt="Pattern Analysis launched Manually" type="video" />
