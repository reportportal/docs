...
<media-view thumbnail={require('./img/AutoPattern.png')} src="https://youtu.be/XgJr5Nm7OrI" alt="AutoPattern" type="video" />
...
<media-view thumbnail={require('./img/ManualPattern.png')} src="https://youtu.be/5YaN85x6_hc" alt="ManualPattern" type="video" />
