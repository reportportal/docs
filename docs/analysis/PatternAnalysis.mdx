...
<MediaViewer thumbnail={require('./img/PatternAnalysis/AutoPatternAnalysis.png')} src="https://youtu.be/K3Wk_S4Cuko" alt="Pattern Analysis launched Automatically" type="video" />
...
<MediaViewer thumbnail={require('./img/PatternAnalysis/ManualPatternAnalysis.png')} src="https://youtu.be/_BhG0Tu4H_I" alt="Pattern Analysis launched Manually" type="video" />
