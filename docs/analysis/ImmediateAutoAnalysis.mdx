...
:::note
If a test has retries and the test structure contains nested steps, the assignment of defects is determined by the ["Defect assignment based on the longest retry" checkbox](/analysis/AutoAnalysisOfLaunches#defect-assignment-based-on-the-longest-retry) in the Auto-Analysis settings.<br />
* If the checkbox is not checked, ReportPortal sends the logs of the latest retry to the Analyzer.<br />
