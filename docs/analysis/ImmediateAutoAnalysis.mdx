...
:::note
If a test has retries and the test structure contains nested steps, the assignment of defects is determined by the ["Defect assignment based on the longest retry" checkbox](./AutoAnalysisOfLaunches.mdx#defect-assignment-based-on-the-longest-retry) in the Auto-Analysis settings.<br />
