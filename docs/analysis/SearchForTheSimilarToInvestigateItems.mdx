...
<media-view thumbnail={require('./img/SearchForTheSimilarToInvestigateItems.png')} src="https://youtu.be/FyDdMX_PVyc" alt="Search for the similar To investigate items" type="video" />
...
<media-view src={require('./img/SearchSimilarToInvestigate1.png')} alt="Search for the similar To investigate items for the faster bug triage" />
