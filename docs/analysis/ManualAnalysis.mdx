...
<media-view thumbnail={require('./img/ManualAnalysis/MakeDecision.png')} src="https://youtu.be/ZdUj3SFqJV8" alt="Make Decision modal" type="video" />
...
<media-view thumbnail={require('./img/ManualAnalysis/MakeDecisionBulk.png')} src="https://youtu.be/Jd9Ge0epQzg" alt="Bulk update with Make Decision" type="video" />
