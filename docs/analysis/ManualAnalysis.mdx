...
<media-view src={require('./img/ManualAnalysis/MakeDecision7.png')} alt="Analyzer suggestions" />
...
<media-view src={require('./img/ManualAnalysis/MakeDecision8.png')} alt="History of the test" />
