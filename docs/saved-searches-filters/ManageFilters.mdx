...
<media-view thumbnail={require('./img/shareFilter.png')} src="https://youtu.be/8vw-nr6FSwI" alt="shareFilter" type="video" />
...
<media-view thumbnail={require('./img/manageFilters.png')} src="https://youtu.be/FKWL3-jTVWs" alt="manageFilters" type="video" />
