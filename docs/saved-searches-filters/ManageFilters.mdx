...
<media-view thumbnail={require('./img/EditFilter.png')} src="https://youtu.be/wU3S7Yk6pSY" alt="Edit Filter" type="video" />
...
<media-view thumbnail={require('./img/ManageFilters.png')} src="https://youtu.be/tT5bGfVzuCg" alt="Manage Filters in our test automation dashboard" type="video" />
