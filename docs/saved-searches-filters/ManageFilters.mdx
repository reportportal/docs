...
description: Manage saved filters with edit, copy, delete, and share operations. Organize filters for efficient test execution reporting and dashboard creation.
---
...
<MediaViewer src="https://youtu.be/wU3S7Yk6pSY" alt="Edit Filter" type="video" />
...
<MediaViewer src="https://youtu.be/tT5bGfVzuCg" alt="Manage Filters in our test automation dashboard" type="video" />
