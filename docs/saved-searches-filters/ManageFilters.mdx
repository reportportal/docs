...
:::note
A filter related to the widget, becomes shared once the related widget is shared.
:::
**CLONE** -
...
<media-view thumbnail={require('./img/ManageFilters.png')} src="https://youtu.be/FKWL3-jTVWs" alt="Manage Filters in our test automation dashboard" type="video" />
