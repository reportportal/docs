---
sidebar_label: How to report attributes to ReportPortal
description: Learn how to report attributes to ReportPortal to categorize, filter, and analyze test data effectively, enhancing your test management process.
---
...
Be sure to check out our dedicated article for [best practices on using attributes](../working-with-test-results/AutomatedAndAgenticLaunchTestItemAttributes.mdx) effectively.
