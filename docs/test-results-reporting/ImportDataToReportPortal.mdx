...
To start the import process, you should have at least one import plugin enabled: either [JUnit](../../integrations/import/JUnit) or [RobotFramework](../../integrations/import/RobotFramework).
