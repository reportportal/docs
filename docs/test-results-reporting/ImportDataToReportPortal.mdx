...
To start the import process, you should have at least one import plugin enabled: either [JUnit](../integrations/import/JUnit.mdx) or [RobotFramework](../integrations/import/RobotFramework.mdx).
...
:::info
Admin, Manager, and user with edit permissions can import data to ReportPortal.
:::
