...
<media-view src={require('./img/OptimalPerformanceHardwareSetup1.png')} alt="Kubernetes server types for our centralized test automation tool" />
...
<media-view src={require('./img/OptimalPerformanceHardwareSetup3.png')} alt="Additional nodes for Elasticsearch in ReportPortal Testops" />
...
<media-view src={require('./img/OptimalPerformanceHardwareSetup2.png')} alt="Elasticsearch Performance Tuning in our test automation dashboard" />
