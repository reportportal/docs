...
<MediaViewer src={require('./img/OptimalPerformanceHardwareSetup3.png')} alt="Additional nodes for Elasticsearch in ReportPortal Testops" />
...
<MediaViewer src={require('./img/OptimalPerformanceHardwareSetup2.png')} alt="Elasticsearch Performance Tuning in our test automation dashboard" />
