...
<media-view src={require('./img/OptimalPerformanceHardwareSetup1.png')} alt="Kubernetes Server Types" />
...
<media-view src={require('./img/OptimalPerformanceHardwareSetup3.png')} alt="Additional nodes for Elasticsearch" />
...
<media-view src={require('./img/OptimalPerformanceHardwareSetup2.png')} alt="Elasticsearch Performance Tuning" />
