...
<media-view thumbnail={require('./img/EditPersonalInformation.png')} src="https://youtu.be/yVdo-C8kkkU" alt="Edit Personal Info in our test automation results dashboard" type="video" />
...
<media-view thumbnail={require('./img/ChangePassword.png')} src="https://youtu.be/WzcQsK-PzyM" alt="Change Password real time dashboard open source" type="video" />
