...
<media-view thumbnail={require('./img/editPersonalInfo.png')} src="https://youtu.be/OLjn090hk18" alt="editPersonalInfo" type="video" />
...
<media-view thumbnail={require('./img/changePassword.png')} src="https://youtu.be/sb_TNHGAIMw" alt="changePassword" type="video" />
