...
<media-view thumbnail={require('./img/EditPersonalInfo.png')} src="https://youtu.be/OLjn090hk18" alt="Edit Personal Info" type="video" />
...
<media-view thumbnail={require('./img/ChangePassword.png')} src="https://youtu.be/sb_TNHGAIMw" alt="Change Password" type="video" />
