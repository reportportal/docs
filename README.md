...
Releases live in a separate unversioned docs instance (`releases/`), linked from the **Releases** tab and served at `/docs/releases/`. They are not snapshotted when you run `npm run version`.
