...
<MediaViewer src={require('./img/azure-dev-ops/AzureDevOps12.png')} alt="Add project Azure DevOps BTS integration" />
...
<MediaViewer src={require('./img/azure-dev-ops/AzureDevOps14.png')} alt="Reset to project Azure DevOps BTS Integrations" />
