...
ReportPortal supports Continuous Testing with built-in functionality – [Quality Gates](/26.1/quality-gates) (premium feature). Quality Gate is a set of predefined criteria that should be met in order launch run to be considered as successful.
...
Finally, configure [integration with CI/CD](/26.1/quality-gates/IntegrationWithCICD) to send results to the pipeline.
